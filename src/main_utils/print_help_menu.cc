...
namespace main_utils {
    void print_help_menu() noexcept {
        ...
        fputs("        --remove-exports,                    Remove exports field from written tbds\n", stdout);
        fputs("        --remove-flags,                      Remove flags field from written tbds\n", stdout);
        fputs("        --remove-objc-constraint,            Remove objc-constraint field from written tbds\n", stdout);
        fputs("        --remove-parent-umbrella,            Remove parent-umbrella field from written tbds\n", stdout);
        fputs("        --remove-swift-version,              Remove swift-version field from written tbds\n", stdout);
        fputs("        --remove-uuids,                      Remove uuids field from written tbds\n", stdout);
        fputs("        --dont-remove-clients,               Don't Remove clients field from written tbds\n", stdout);
        fputs("        --dont-remove-current-version,       Don't remove current-version field from written tbds\n", stdout);
        fputs("        --dont-remove-compatibility-version, Don't remove compatibility-version field from written tbds\n", stdout);
        fputs("        --dont-remove-exports,               Don't remove exports field from written tbds\n", stdout);
        fputs("        --dont-remove-flags,                 Don't remove flags field from written tbds\n", stdout);
        fputs("        --dont-remove-objc-constraint,       Don't remove objc-constraint field from written tbds\n", stdout);
        fputs("        --dont-remove-parent-umbrella,       Don't remove parent-umbrella field from written tbds\n", stdout);
        fputs("        --dont-remove-swift-version,         Don't remove swift-version field from written tbds\n", stdout);
        fputs("        --dont-remove-uuids,                 Don't remove uuids field from written tbds\n", stdout);
